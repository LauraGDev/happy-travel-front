    ...
    <div className="flex relative">
        ...
        method="post" >
            ...
            <input 
                ...
                // onFocusCapture={() => setHideSuggestions(false)}
                // onBlur={() => {
                //     setTimeout(() => {
            ...
            <button
                type="submit"
                className="ml-2"
                // className="absolute left-[8.4rem] top-1/2 transform -translate-y-1/2 pointer-events-none"
                >
            ...
            {/* <div className={`absolute top-full left-0 mt-2 w-full bg-white shadow-lg rounded-lg ${hideSuggestions ? 'hidden' : ''}`}>
                {suggestions.map((suggestion) => (
                    <div 
                    key={suggestion.name}
                    className="p-2 border-b last:border-b-0 h-fit absolute z-10"
